...
public class AliPay {
  ...
  public void payV2(String total_amount, final String content ,final String order_trade_no, final AlipayCallBack callBack) {
    ...
    Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(Constants.AliPay.APPID, total_amount, content, order_trade_no,Constants.AliPay.USER_RSA2);
    String orderParam = OrderInfoUtil2_0.buildOrderParam(params);
    String sign = OrderInfoUtil2_0.getSign(params, Constants.AliPay.RSA_PRIVATE,Constants.AliPay.USER_RSA2);
