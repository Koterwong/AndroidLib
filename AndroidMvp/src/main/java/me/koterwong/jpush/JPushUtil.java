...
public class JPushUtil {
  ...
  public static void startPushService(Context context, String alise) {
    JPushInterface.resumePush(context);
    try {
      final String alias = getJPushAliasAndTag(alise);
      JPushInterface.setAlias(context, alias, getAliasAndTadCallBack());
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
